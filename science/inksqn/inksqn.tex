...
\title{\Large \textbf{Bewusstsein von Konsequenzen}\\
...
\section{Grundlagen: Knoten, Kanten und Kausalität}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.7\textwidth]{plot_1_graph_knoten_kanten.pdf}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.95\textwidth]{plot_6_konsequenzverzögerung.pdf}
