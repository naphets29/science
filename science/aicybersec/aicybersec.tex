...
\begin{enumerate}
	...
	\item Algorithmen zur Berechnung minimaler Diversitätsgrade für IT-Dienstleister.
\end{enumerate}
...
Analogie zu Abschnitt 3 von \cite{Epp26a}. Dort wurde die Wahrscheinlichkeit $P_{\mathrm{Safety}}(n,p)$ berechnet, dass ein System mit $n$ redundanten Kanälen, von denen jeder mit Wahrscheinlichkeit $p$ kompromittiert ist, dennoch mehrheitskorrekt funktioniert. Hier entwickeln wir ein analoges Modell für KI-Angreifer.
