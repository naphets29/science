...
% Lokale, paketfreie Einheitenformatierung für portable MiKTeX-Installationen.
\providecommand{\SI}[2]{\ensuremath{#1\,#2}}
\providecommand{\si}[1]{\ensuremath{#1}}
\providecommand{\num}[1]{#1}
\providecommand{\ang}[1]{\ensuremath{#1\,\mathrm{arcmin}}}
\providecommand{\DeclareSIUnit}[2]{\providecommand{#1}{\mathrm{#2}}}
\providecommand{\kilo}{\mathrm{k}}
\providecommand{\hecto}{\mathrm{h}}
\providecommand{\micro}{\mathrm{\mu}}
\providecommand{\nano}{\mathrm{n}}
\providecommand{\giga}{\mathrm{G}}
\providecommand{\per}{/}
\providecommand{\square}{\mathrm{square}}
\providecommand{\squared}{2}
\providecommand{\steradian}{\mathrm{sr}}
\providecommand{\watt}{\mathrm{W}}
\providecommand{\metre}{\mathrm{m}}
\providecommand{\pascal}{\mathrm{Pa}}
\providecommand{\kelvin}{\mathrm{K}}
\providecommand{\radian}{\mathrm{rad}}
\providecommand{\second}{\mathrm{s}}
\providecommand{\minute}{\mathrm{min}}
\providecommand{\bar}{\mathrm{bar}}
\providecommand{\parsec}{\mathrm{pc}}
\providecommand{\year}{\mathrm{yr}}
\renewcommand{\year}{\mathrm{yr}}
...
am Horizont jedoch nahezu $\ang{34}$ erreicht,
...
Grundlagen dar.
Abschnitt~\ref{sec:dispersion} behandelt die wellenlängenabhängige Dispersion.
...
Thermosphäre      & $85$--$\SI{600}{\kilo\metre}$ & $<$0.003    & 185$\uparrow$      & $\approx 0$\\
\bottomrule
\end{tabular}
\end{table}
...
einer einzigen Wellenlänge ($\lambda$ ≈ 550 nm, grünes Licht) behandelt.
In Wirklichkeit ist weißes Sonnenlicht jedoch ein Kontinuum verschiedener
Wellenlängen: von ultraviolett ($\lambda$ ≈ 300 nm) über sichtbar
($\lambda$ ≈ 380–700 nm) bis infrarot ($\lambda$ ≈ 1000 nm und darüber).
...
\end{equation}
wobei $\lambda$ in Mikrometern ($\mu$m) einzusetzen ist.
...
bei der Referenzwellenlänge $\lambda_0$ ≈ 589 nm (Natrium-D-Linie) ist.
...
\begin{table}[htbp]
	...
	\begin{tabular}{lrrl}
		\toprule
		Wellenlänge $\lambda$ & Farbe/Region & $(n-1) \times 10^6$ & Relative\\
		            & & & Dispersion \\
		\midrule
...
Bei $\lambda$ = 550 nm erhalten wir:
\begin{equation}
...
\begin{equation}
  \frac{\partial R}{\partial \lambda}\bigg|_{z=90^\circ} = b(90^\circ) \cdot \frac{\partial n_0}{\partial \lambda}.
...
Für typische Werte am Horizont (zenithaler Abstand $z = 90^\circ$):
- Koeffizient: $b(90°) \approx 0.087$ (dimensionslos, abhängig von Temperatur- und Druckprofil)
- Bei $\lambda$ = 450 nm (Blau): $|\partial n_0/\partial \lambda| \approx 7.4 \times 10^{-4}$ nm$^{-1}$
- Bei $\lambda$ = 650 nm (Rot): $|\partial n_0/\partial \lambda| \approx 1.9 \times 10^{-4}$ nm$^{-1}$

Dies ergibt für die Refraktionsdifferenz zwischen Blau (450 nm) und Rot (650 nm):
\begin{equation}
  \Delta R_{\mathrm{Blau-Rot}} = b(90^\circ) \cdot \int_{650}^{450} \frac{\partial n_0}{\partial \lambda} \, \mathrm{d}\lambda
	\approx 0.087 \times 2.8 \times 10^{-4} \approx \boxed{\SI{24}{\micro\radian} \approx \ang{5}}.
	\label{eq:delta_R_br}
\end{equation}
...
Am Horizont ($z = 90^\circ$) wird die Airmass sehr groß; eine genaue
numerische Integration ergibt $\mathrm{AM}(90^\circ) \approx 38$.
...
\begin{enumerate}
	\item \textbf{Eingabe:} Wellenlänge $\lambda$, Zenitwinkeldistanz $z$,
...
Die Differenz beträgt etwa $\ang{2}$ zwischen Violett und Rot,
...
Betrachten wir konkret die Dispersion zwischen Violett ($\lambda$₁ = 380 nm) und Rot ($\lambda$₂ = 700 nm)
am Horizont ($z = 90^\circ$).
...
\begin{equation}
  \begin{aligned}
  n(380\,\mathrm{nm}) - 1
  &= \frac{6432.8 \times 10^{-8}}{(0.380)^2}
   + \frac{2949810 \times 10^{-8}}{(0.380)^4} \\
  &= 4.453 \times 10^{-4} + 1.713 \times 10^{-4} \\
  &= 6.166 \times 10^{-4}.
  \end{aligned}
	\label{eq:n_380}
\end{equation}
...
\begin{equation}
  \begin{aligned}
  n(700\,\mathrm{nm}) - 1
  &= \frac{6432.8 \times 10^{-8}}{(0.700)^2}
   + \frac{2949810 \times 10^{-8}}{(0.700)^4} \\
  &= 1.312 \times 10^{-4} + 8.609 \times 10^{-5} \\
  &= 2.173 \times 10^{-4}.
  \end{aligned}
	\label{eq:n_700}
\end{equation}
...
\begin{equation}
  R(z=90^\circ) \approx \frac{C}{\tan(z + d)} \quad \text{mit Korrektur},
...
\begin{equation}
  \begin{aligned}
    R(\lambda = 380\,\mathrm{nm}, z=90^\circ) &= 35.24\,\text{arcmin}\\
    R(\lambda = 700\,\mathrm{nm}, z=90^\circ) &= 33.18\,\text{arcmin}
	\end{aligned}
	\label{eq:R_concrete}
\end{equation}
...
\begin{equation}
  ...
  \Delta R
  &= R(380) - R(700) \\
  &= 35.24 - 33.18 = \boxed{2.06\,\text{arcmin}}.
  \end{aligned}
...
\begin{equation}
  \begin{aligned}
  \Delta s
  &= 2.06\,\text{arcmin} \times \frac{\pi}{180 \times 60} \\
  &= 5.99 \times 10^{-4}\,\text{rad}.
  \end{aligned}
	\label{eq:linear_sep}
\end{equation}
...
Am Horizont ist $\sec(90^\circ) = \infty$, aber die numerische Integration mit
der Airmass-Funktion gibt $\mathrm{AM}(90^\circ) \approx 37.9$.

Damit:
\begin{equation}
  \begin{aligned}
  \tau(380\,\mathrm{nm}, z=90^\circ)
  &= 37.9 \times 0.12 \times \left(\frac{550}{380}\right)^4 \\
  &= 4.548 \times 0.12 \times (1.447)^4 \\
  &= 37.9 \times 0.12 \times 4.396 = 19.99.
  \end{aligned}
	\label{eq:tau_380}
\end{equation}
...
\begin{equation}
  \begin{aligned}
  \tau(700\,\mathrm{nm}, z=90^\circ)
  &= 37.9 \times 0.12 \times \left(\frac{550}{700}\right)^4 \\
  &= 37.9 \times 0.12 \times (0.786)^4 \\
  &= 37.9 \times 0.12 \times 0.381 = 1.737.
  \end{aligned}
	\label{eq:tau_700}
\end{equation}
...
\begin{equation}
  ...
  &= \int_{\text{sichtbar}}
  \begin{pmatrix} \bar{r}(\lambda) \\ \bar{g}(\lambda) \\ \bar{b}(\lambda) \end{pmatrix} \\
  &\quad \cdot I_{\mathrm{obs}}(\lambda) \, \mathrm{d}\lambda,
  \end{aligned}
	\label{eq:RGB}
\end{equation}
...
\begin{table}[p]
	...
	\begin{tabular}{ccccccc}
		\toprule
		$\lambda$ (nm) & Farbe & z=0° & z=45° & z=60° & z=80° & z=90° \\
		& & R (′) & R (′) & R (′) & R (′) & R (′) \\
		\midrule
...
\begin{equation}
  \begin{aligned}
  \Delta D
  &= \frac{2 \times 2.06\,\text{arcmin}}{32\,\text{arcmin}} \\
  &\approx 13\,\%,
  \end{aligned}
...
\begin{align}
  A &= \delta_0\,\frac{r_E}{H} \approx \ang{58.1}, \\
  B &\approx \ang{0.07}
\end{align}
...
\begin{equation}
  R_{\text{Horizont}} \approx \ang{34.5}.
  \label{eq:R_horizont}
\end{equation}

Diese Brechung hat eine fundamentale Konsequenz:
Der scheinbare Halbmesser der Sonne beträgt $\approx \ang{16}$,
...
\begin{enumerate}
  \item \textbf{Öffnungswinkel des Sonnenkegels.}
        ...
        $\alpha_\odot \approx \ang{16}$ (Gleichung~\ref{eq:alpha_sonne}).

  \item \textbf{Brechung durch alle Schichten.}
        Jede Schicht lenkt das Bündel zusätzlich um $\delta_i$ ab.
        Die Summe $R_N$ beträgt am Horizont $\approx\ang{34.5}$
...
Numerisch ergibt sich $\Delta R \approx \ang{5}$,
...
$\alpha \approx \ang{14}$ -- in Übereinstimmung mit
...
\begin{tikzpicture}[scale=1.35, >=Stealth, font=\small]
  ...
  %% â”€â”€ Atmosphärenschichten als horizontale Bänder â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  %% â”€â”€ Schichtgrenzen â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  %% â”€â”€ Schichtbeschriftungen (links, innerhalb der Bänder) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  %% â”€â”€ Strahlkoordinaten (kaskadierende Brechung, Winkel übertrieben) â”€â”€â”€â”€â”€â”€
  %  Einstrahlwinkel zur Vertikalen (Lot):
  %    Vakuum:        Î±â‚€ = 35 °   horizontal = 55 ° von oben
  %    Thermosphäre:  Î±â‚ = 40 °
  %    Mesosphäre:    Î±â‚‚ = 48 °
  %    Stratosphäre:  Î±â‚ƒ = 55 °
  %    Troposphäre:   Î±â‚„ = 68 °   (stärkste Brechung)
  \coordinate (P0) at (8.5, 5.8);     % Sonne / Vakuum (Eintritt)
  \coordinate (P1) at (6.93, 4.5);    % Grenze Vakuum â€“ Thermosphäre
  \coordinate (P2) at (6.10, 3.8);    % Grenze Thermosphäre â€“ Mesosphäre
  \coordinate (P3) at (5.20, 2.8);    % Grenze Mesosphäre â€“ Stratosphäre
  \coordinate (P4) at (4.08, 1.2);    % Grenze Stratosphäre â€“ Troposphäre
  \coordinate (P5) at (3.60, 0.0);    % Erdoberfläche (Beobachter)

  %% â”€â”€ Geometrischer (ungebrochener) Strahl â€“ gestrichelt rot â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  %  Verlängerung der Vakuum-Richtung (35 ° zur Horizontalen) bis y = 0
  %  Î”y = 5.8  â†’  Î”x = 5.8 / tan35 ° = 8.28  â†’  x_ende = 8.5 âˆ’ 8.28 = 0.22
  \draw[red, dashed, thick] (P0) -- (0.22, 0.0)
    node[above right, font=\scriptsize, red!70!black, xshift=-10pt] {};

  %% â”€â”€ Gebrochener Strahl (stückweise gerade, Snell an jeder Grenzfläche) â”€
  ...
  %% â”€â”€ Brechungspunkte hervorheben â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  %% â”€â”€ Lots (Normale zur Grenzfläche = vertikal) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  %% â”€â”€ Snell-Gleichungen an jeder Grenzfläche â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  %% â”€â”€ Eintrahlwinkel-Bögen (Î¸áµ¢) an den Grenzflächen â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  % P3: Hauptbrechung, größter Schritt â€“ beschriften
  ...
  %% â”€â”€ Beobachter â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  \fill (P5) circle (0.11);
  \node[below, font=\small\bfseries] at (P5) {Beobachter};

  %% â”€â”€ Scheinbare Sonnenrichtung (entlang letztem Strahlsegment zurück) â”€â”€â”€â”€
  \draw[->, very thick, orange!90!black]
    (P5) -- ++(68:1.9)
    node[above right, font=\footnotesize] {scheinbare Sonnenposition};

  %% â”€â”€ Wahre (geometrische) Sonnenrichtung â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  \draw[->, very thick, red, dashed]
    (P5) -- ++(35:1.9)
    node[right, font=\footnotesize, yshift=-6pt] {wahre Sonnenposition};

  %% â”€â”€ Brechungswinkel R (Gesamtablenkung) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  \draw[<->, thick, purple]
    ($(P5)+(35:1.65)$) arc (35:68:1.65)
    node[midway, right, xshift=4pt, font=\footnotesize, align=left]
      {$R \approx 34'$\\{\tiny (stark übertrieben)}};

  %% â”€â”€ Horizont â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  \draw[dotted, thick, black!45]
    ($(P5)+(-1.5,0)$) -- ($(P5)+(2.2,0)$)
    node[right, font=\scriptsize, black!50] {Horizont};

  %% â”€â”€ Sonne â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  \node[font=\LARGE, orange!90!black] at (9.2, 5.7) {$\odot$};
  \node[font=\footnotesize, orange!80!black, below] at (9.2, 5.5) {Sonne};

  %% â”€â”€ Legende unten â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
\caption{%
  ...
  Die Gesamtablenkung $R \approx \ang{34}$ bewirkt,
...
\begin{tikzpicture}
  \begin{axis}[
    ...
    % Näherungsformel R approx 1.02 / tan(z + 10.3/(z+5.11)) in Bogenminuten
...
\subsection{Sonnenlicht - Formaler Vergleich}
...
\begin{enumerate}
  ...
  \item \textbf{Verlängerte Tagesdauer.}
        ...
        obwohl die Sonne geometrisch bereits ($\approx \ang{34.5}$
...
$R_{\mathrm{Horizont}} \approx \ang{34.5}$,
...
nur $\approx \ang{6}$ \citep{Kliore1972},
...
% â”€â”€ 17 ergänzte Quellen â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
